...
window.addEventListener('load', function () {
    ...
    div.innerHTML = '<div id="minimapbg" style="position: absolute; right: 1em; bottom: 1em; z-index: 2;">' +
        '<div class="posy" id="posyt" style="background-size: 100%; background-image: url(https://image.ibb.co/eoR60z/vbg.png); color: rgb(255, 255, 255); text-align: center; line-height: 42px; vertical-align: middle; width: auto; height: auto; border-radius: 21px; padding: 6px;">' +
